...
import { Accordion, AccordionContent, AccordionItem, AccordionTrigger } from '@ohif/ui-next/components/Accordion/Accordion';
import { Tooltip, TooltipContent, TooltipTrigger } from '@ohif/ui-next/components/Tooltip/Tooltip';
