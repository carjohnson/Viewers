...
import { Icons } from '@ohif/ui-next/components/Icons/Icons';
import { DisplaySetMessageListTooltip } from '@ohif/ui-next/components/DisplaySetMessageListTooltip/DisplaySetMessageListTooltip';
import { TooltipTrigger, TooltipContent, Tooltip } from '@ohif/ui-next/components/Tooltip/Tooltip';
        ...
        <div className="flex h-[52px] w-[128px] flex-col justify-start pt-px">
          <Tooltip>
            ...
            <TooltipTrigger>
              ...
              <div
                className={classnames(
                  'min-h-[18px] w-[128px] overflow-hidden text-ellipsis whitespace-nowrap pb-0.5 pl-1 text-left text-[12px] font-normal leading-4',
                  isFlagged ? 'text-yellow-400 font-semibold' : 'text-white'
                )}
                data-cy="series-description-label"
              >
                {isFlagged && <Icons.StatusTracking className="inline mr-1 h-3 w-3" />}
                {description}
              </div>
            </TooltipTrigger>
          </Tooltip>
