  ...
  dataSources: [
    ...
    // added for deployment to Render (April 2026, June 2026)
    {
      ...
      configuration: {
        ...
        name: 'orthanc',
        qidoRoot: 'https://webquiz-orthanc-server.onrender.com/dicom-web',
        wadoRoot: 'https://webquiz-orthanc-server.onrender.com/dicom-web',
        wadoUriRoot: 'https://webquiz-orthanc-server.onrender.com/dicom-web',
        qidoSupportsIncludeField: true,
        supportsReject: false,
        imageRendering: 'wadors',
        thumbnailRendering: 'wadors',
